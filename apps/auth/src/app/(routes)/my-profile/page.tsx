...
const searchPrefix = (
  <SearchOutlined
    style={{ fontSize: 16, color: '#ADA7A7', marginInline: 10 }}
  />
);
    ...
    <div className='my-profile-page-container'>
      ...
      <div className='header-section'>
        ...
        <div className='header-left'>
          ...
          <div style={{ fontSize: '0.75rem', color: '#ADA7A7' }}>
      ...
      <div className='body-section'>
        ...
        <div className='form-section'>
          ...
          <div className='form-vertical-divider'>
            <InputWithTagName
              ...
              disabled={!isEditing}
              variant='outlined'
              placeholder='Username Last Name'
            />
            <InputWithTagName
              tagName='Email'
              size='large'
        ...
        <Button
          ...
          color='danger'
          onClick={() => {
            window.location.assign('http://localhost:3003/login');
          }}
        >
          Sign Out
        </Button>
